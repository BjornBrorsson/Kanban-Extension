...
var orchestratorCli_exports = {};
__export(orchestratorCli_exports, {
  runCli: () => runCli
});
module.exports = __toCommonJS(orchestratorCli_exports);
...
var isDirectCliInvocation = typeof process !== "undefined" && Boolean(process.argv[1]) && (path12.basename(process.argv[1]) === "cli.js" || path12.basename(process.argv[1]) === "orchestratorCli.js" || path12.basename(process.argv[1]) === "kanban-orch");
